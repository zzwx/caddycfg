module github.com/zzwx/caddycfg

go 1.18

require (
	github.com/antlr/antlr4/runtime/Go/antlr v0.0.0-20220626175859-9abda183db8e
	github.com/caddyserver/caddy/v2 v2.5.2-0.20220622225346-10f85558ead1
)
...
require (
	...
	github.com/smallstep/certificates v0.20.0 // indirect
	github.com/smallstep/cli v0.20.0 // indirect
